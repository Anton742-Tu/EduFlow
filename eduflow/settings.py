...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("POSTGRES_USER", "eduflow_user"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "eduflow_password"),
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "noreply@eduflow.com")
